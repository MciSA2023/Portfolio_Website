...
function Projekt({ preViewurl , imageUrl }) {
    ...
    return (
        <div className={`projekt_karte ${showDetails ? 'open' : ''}`} onClick={toggleDetails}>
            {showDetails ? (
                ...
                <div className="projekt_preview_container">
                    <img className='projekt_bild' src={preViewurl} alt="Projektbild" />
                </div>
            )}
        </div>
    );
